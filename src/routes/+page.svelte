	...
	<section class="py-5">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-12 col-12">
					<div class="card shadow-sm">
						<div class="card-header">
							Data Artikel
							{#if params}
								<button class="btn btn-primary float-end" onclick={() => exportToExcel(articles)}
				...
				<div class="col-lg-4 col-md-12 col-12 order-lg-last order-first">
					<div class="card shadow-sm mb-3">
						<div class="card-header">Cari Author</div>
						<div class="card-body">
								...
								<div class="col-lg-6 col-md-12 col-12">
									<div class="mb-3">
										<button
											...
											type="submit"
											onclick={() => (window.location.href = `/?id=${id}`)}>Kirim</button
										>
									</div>
								</div>
							</div>
